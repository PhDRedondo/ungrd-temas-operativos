...
export const SOURCE_FIELDS: FormField[] = [
  ...
  { name: "_kind", label: "Tipo interno", type: "text", excelWidth: 16 },
  { name: "hoja_id", label: "Hoja de seguimiento", type: "text", excelWidth: 18 },
  { name: "pestana", label: "Pestaña", type: "text", excelWidth: 22 },
  { name: "detalle", label: "Detalle", type: "textarea", excelWidth: 40 },
  { name: "valor_asignado", label: "Valor asignado", type: "number", excelWidth: 16 },
  { name: "valor_con_cdp", label: "Valor con CDP", type: "number", excelWidth: 16 },
  { name: "saldo_por_expedir_cdp", label: "Saldo por expedir CDP", type: "number", excelWidth: 18 },
  { name: "saldo_por_expedir_rc", label: "Saldo por expedir RC", type: "number", excelWidth: 18 },
  { name: "sin_rc", label: "Sin RC", type: "number", excelWidth: 14 },
  { name: "modalidad", label: "Modalidad", type: "text", excelWidth: 22 },
];
